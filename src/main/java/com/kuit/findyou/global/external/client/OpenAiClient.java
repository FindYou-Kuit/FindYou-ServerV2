...
public class OpenAiClient {
    ...
    private static final String PROMPT = """
            ...
            - The breed must be exactly one, and it must match the species category:
             ...
             \
            If the species is "개":
             골든 리트리버, 라브라도 리트리버, 시바, 포메라니안, 치와와, 말티즈, 요크셔 테리어, 푸들, 보더 콜리, 허스키, 코기, 닥스훈트, 불독, 비글, 고든 세터, 그레이 하운드, 그레이트 덴, \
            그레이트 피레니즈, 그리펀 벨지언, 꼬똥 드 뚤레아, 네오폴리탄 마스티프, 노르포크 테리어, 노리치 테리어, 노퍽 테리어, 뉴펀들랜드, 달마시안, 댄디 딘몬트 테리어, 도고 까니리오, 도고 아르젠티노, 도베르만, 도사, 도사 믹스견, 동경견, \
            라고토 로마그놀로, 라사 압소, 래빗 닥스훈트, 랫 테리어, 러시안 토이, 러프콜리, 레이크랜드 테리어, 로디지안 리즈백, 로트와일러, 로트와일러 믹스견, 마리노이즈, 마스티프, 말라뮤트, 맨체스터테리어, 미니어쳐 닥스훈트, 미니어쳐 불 테리어, \
            ...
            벨지안 셰퍼드 독(테르뷰렌), 보르조이, 보스턴 테리어, 복서, 볼로네즈, 부비에 데 플랑드르, 브뤼셀그리펀, 브리타니 스파니엘, 블랙 테리어, 비숑 프리제, 비어디드 콜리, 비즐라, 빠삐용(콘티넨탈 토이 스파니엘), 사모예드, 살루키, 삽살개, 샤페이, 세인트 버나드, \
            센트럴 아시안 오브차카, 셔틀랜드 쉽독, 셰퍼드, 슈나우져, 스무스콜리, 스코티쉬 테리어, 스코티시 디어하운드, 스키퍼키, 스태퍼드셔 불 테리어, 스태퍼드셔 불 테리어 믹스견, 스탠다드 닥스훈트, 스탠다드 푸들, 스피츠, 슬루기, 시바 이누, 시베리안 허스키, 시잉프랑세즈, \
            ...
            올드 잉글리쉬 불독, 올드 잉글리쉬 쉽독, 와이마라너, 울프독, 웨스트 시베리언 라이카, 웨스트하이랜드화이트테리어, 웰시 스프링어 스패니얼, 웰시 코기 카디건, 웰시 코기 펨브로크, 웰시 테리어, 유쿠시안 라이카, 이스트 시베리언 라이카, 이탈리안 그레이 하운드, 잉글리쉬 세터, 잉글리쉬 스프링거 스파니엘, \
            ...
            카네 코르소, 카레리안 베어독, 카이훗, 캉갈 셰퍼드 독, 캐벌리어 킹 찰스 스파니엘, 케나디언 에스키모 독, 케니스펜더, 케리 블루 테리어, 케언 테리어, 코리아 트라이 하운드, 코리안 마스티프, 코카 스파니엘, 코카 푸, 코카시안 오브차카(코카시안 셰퍼드 독), 클라인스피츠, 키슈, 키스 훈드, 타이 리지벡 독, \
            ...
            If the species is "고양이":
             러시안 블루, 페르시안, 메인쿤, 브리티시 쇼트헤어, 샴, 벵갈, 아메리칸 쇼트헤어, 스코티시폴드, 노르웨이 숲, 터키시 앙고라, 고양이, 기타, 니벨룽, 데본 렉스, 레그돌, 레그돌-라가머핀, 맹크스, 먼치킨, 믹스묘, 발리네즈, \
            ...
            The color must be chosen from the following fixed list:
             검은색, 노란색, 갈색, 하얀색, 회색, 적색, 점박이, 줄무늬, 기타
